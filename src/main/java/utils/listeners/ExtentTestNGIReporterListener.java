...
public class ExtentTestNGIReporterListener implements IReporter {
    ...
    private void init() {
        ...
        this.extent.setSystemInfo("os.name", properties.getProperty("os.name", "未知"));
        this.extent.setSystemInfo("os.arch", properties.getProperty("os.arch", "未知"));
        this.extent.setSystemInfo("os.version", properties.getProperty("os.version", "未知"));
        this.extent.setSystemInfo("java.version", properties.getProperty("java.version", "未知"));
        this.extent.setSystemInfo("java.home", properties.getProperty("java.home", "未知"));
        this.extent.setSystemInfo("user.name", properties.getProperty("user.name", "未知"));
        this.extent.setSystemInfo("user.dir", properties.getProperty("user.dir", "未知"));
